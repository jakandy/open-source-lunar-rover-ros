...
#
# Notes:
#   This script can be used to tweak the behaviour of the rover
#   or how it is simulated.
#   Usage:
#       1) Change a parameter's value
#       2) Run the script to export a yaml
...
def writeYamlToFile(py_obj,filename):
    with open(f'{filename}.yaml', 'w',) as f :
        f.write('# This file was generated by oslr_config/config/parameters.py \n\n')
